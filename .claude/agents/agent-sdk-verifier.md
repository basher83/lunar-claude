...
1. **Read the relevant files**:
   ...
   - .gitignore (verify .venv, .ruff_cache, .pytest_cache, etc are excluded)
   - Any configuration files

2. **Check SDK Documentation Adherence**:

   - Use @plugins/devops/python-tools/skills/claude-agent-sdk skill to reference the official Python SDK patterns
