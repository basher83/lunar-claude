...
Before starting, use the **claude-agent-sdk skill** to access patterns, examples, and the validation checklist.
...
Launch the **agent-sdk-verifier** subagent for comprehensive automated review:
