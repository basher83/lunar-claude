...
- FAIL if <50%
- Use this regex for specificity: `'SKILL\.md|YAML|\.skill|skill|research|validation|specification|compliance|frontmatter|Claude'`
...
12. **Use deterministic scoring** - Follow the EXACT "Deterministic Effectiveness Scoring (v4)" section for all effectiveness calculations. Use binary PASS/FAIL for each of the 6 checks. NO subjective assessments in the score.
