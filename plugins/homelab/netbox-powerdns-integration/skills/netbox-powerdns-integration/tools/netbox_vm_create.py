...
def main(
    ...
    ip: str | None = typer.Option(None, help="Specific IP address (e.g., 192.168.3.50/24)"),
    prefix: str = typer.Option("192.168.3.0/24", help="Prefix for auto IP assignment"),
    dns_name: str | None = typer.Option(None, help="Custom DNS name (FQDN)"),
    description: str | None = typer.Option(None, help="VM description"),
    ...
    try:
        ...
        vm_iface = nb.virtualization.interfaces.create(
            virtual_machine=vm.id, name="eth0", type="virtual", enabled=True, mtu=1500
        )
