...
description: >
  Documents the .claude/plugin-name.local.md pattern for storing user-configurable
  plugin settings and state using YAML frontmatter and markdown content.
when_to_use: >
  Use when working with plugin settings, storing plugin configuration, making a plugin
  user-configurable, working with .local.md files, managing plugin state files, or
  reading YAML frontmatter for per-project plugin settings.
---
